...
async function addDepartmentMenu() {
  ...
  try {
    const results = await db.addDepartment(departmentName);
...
async function addRoleMenu() {
  ...
  const results = await db.addRole(
    answers.role_name,
    answers.salary,
    answers.department
  );
...
async function addEmployeeMenu() {
  ...
  const answers = await inquirer.prompt(
    Database.addEmployee(roleChoices, managerChoices)
  );
...
async function updateEmployeeRole() {
  ...
  const answers = await inquirer.prompt(
    Database.updateEmployeeRole(empChoices, roleChoices)
  );
...
async function updateEmployeeManager() {
  ...
  const answers = await inquirer.prompt(
    Database.updateEmployeeManager(empChoices)
  );
  const results = await db.updateEmployeeManager(
    answers.manager,
    answers.employee
  );
  console.table(results);
